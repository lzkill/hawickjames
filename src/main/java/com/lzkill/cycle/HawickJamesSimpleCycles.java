 ...
 * Changes
 * -------
 * 12-Jun-2014 : Initial revision (NO);
 */
package com.lzkill.cycle;
 ...
 * @author Luiz Kill
 */
public class HawickJamesSimpleCycles<V, E> implements
	 ...
	 * 
	 * @param list
	 *            the list from which all the occurrences of u must be removed.
	 */
	 ...
	 *             if the graph argument is <code>null</code>.
	 */
